...
router.get('/get_all_types',ParseNest,vendorAuth,vendorController.getAllTypes);
...
router.post('/upate_booking_staus',ParseNest,vendorAuth,vendorController.updateBookingStatusByVendor);
